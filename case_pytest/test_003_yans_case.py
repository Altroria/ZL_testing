...
if __name__ == "__main__":
    ...
    pytest.main([
        "-s", "-v", "-q",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_th",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_ty",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_bty",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_ss_danw_th",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_ss_danw_ty",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_shiyr_sl_bum_ss_danw_bty",
        case_path + "\\test_002_shenl_case.py::TestYansglCase::test_bum_sl_danw_ty"
    ])
    '''
    pytest.main([
